        ...
        >
          ...
          >
            ...
            <TouchableOpacity
              ...
              style={{ flexDirection: 'row', alignItems: 'center', paddingTop: 8, paddingBottom: 4, gap: 6 }}
            >
              <Ionicons name="chevron-back" size={20} color={ORANGE} />
              <Text style={{ color: ORANGE, fontSize: 14, fontWeight: '600' }}>Indietro</Text>
            </TouchableOpacity>

            {/* ── Header ── */}
            <View style={{ paddingTop: 32, paddingBottom: 32 }}>
              <Text style={{ fontSize: 34, fontWeight: '900', color: '#fff', letterSpacing: -1, marginBottom: 6 }}>
                Crea account
              </Text>
              <Text style={{ fontSize: 15, color: SUB }}>
                Inizia il tuo percorso con{' '}
                <Text style={{ color: ORANGE, fontWeight: '700' }}>Grit</Text>.
              </Text>
            </View>
              ...
              {FIELDS.map((field, idx) => (
                <View key={field.key} style={{ marginBottom: idx < FIELDS.length - 1 ? 16 : 32 }}>
                  ...
                  <View style={{
                    ...
                    shadowColor: focused === field.key ? ORANGE : 'transparent',
                    shadowOffset: { width: 0, height: 0 },
                    shadowOpacity: 0.3, shadowRadius: 8,
                  }}>
                    <Ionicons
                      name={field.icon as any} size={18}
                      color={focused === field.key ? ORANGE : '#333'}
                    />
                    <TextInput
            ...
            >
              <Text style={{ fontSize: 14, color: SUB }}>
                Hai già un account?{' '}
                <Text style={{ color: ORANGE, fontWeight: '700' }}>Accedi</Text>
              </Text>
            </TouchableOpacity>
          </ScrollView>
        </KeyboardAvoidingView>
